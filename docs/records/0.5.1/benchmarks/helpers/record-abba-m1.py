#!/usr/bin/env python3
"""Compare the published 0.5.0 runtime and 0.5.1 candidate on identical storage workloads.
...
def main():
    ...
    try:
        ...
        for path in [ROOT / ".logs/051/baseline-050-target/release/examples/lighter-bench", Path("/opt/homebrew/Cellar/lighter/0.5.0/share/lighter/Image"), Path("/opt/homebrew/Cellar/lighter/0.5.0/share/lighter/rootfs.ext4")]:
        ...
        baseline = ROOT / ".logs/051/baseline-050-target/release/examples/lighter-bench"
        baseline_guest = Path("/opt/homebrew/Cellar/lighter/0.5.0/share/lighter")
