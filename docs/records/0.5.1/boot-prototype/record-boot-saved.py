...
try:
 for memory in a.memory:
  ...
  try:
   ...
   if a.saved_container:run(dk+['create','--name','boot-gate-sentinel',image,'true'],stdout=log,stderr=sp.STDOUT)
