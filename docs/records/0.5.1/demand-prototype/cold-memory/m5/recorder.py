...
root=Path('/Users/nick/git/lighter');source=root;base=root/'.logs/051/demand'
...
cli=base/'lighter-a4';guest=root/'.logs/051/guest-candidate';out=base/'m5-cold-memory-a1'
...
artifacts={str(f):hashlib.file_digest(f.open('rb'),'sha256').hexdigest() for f in [cli,guest/'Image',guest/'rootfs.ext4',base/'source-a4.patch',Path(__file__),root/'.logs/050/benchmark-images/arm64.tar']}
