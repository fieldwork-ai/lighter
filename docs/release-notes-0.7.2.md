...
container check and its shrink policy; the guest's idle footprint carries
the page arrays for all of its RAM (measured on the M1 at 4 GiB:
`docs/worklog.md`, 2026-09-20), and nothing can halve what the kernel has.
