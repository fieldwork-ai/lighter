# Superseded 0.5.1 quarter-RAM candidate qualification

This is retained evidence for runtime `67d787b`, an earlier, unpublished
quarter-RAM candidate. Its artifacts do not contain the selected hybrid runtime.
See [current release qualification](release-0.5.1.md).
...
The [generated performance report](../benchmarks/RELEASE-0.5.1-QUARTER.md) retains every
...
[artifact record](release-0.5.1-quarter-artifacts.json) retains both archive hashes and
