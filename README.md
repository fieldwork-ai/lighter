...
- **Measured startup:** From 0.5.1, Linux boots while the host prepares the remaining RAM in the background, preserving independent 16 KiB backing objects and memory reclamation. Docker readiness and first-container completion are measured separately; the [boot investigation](docs/boot-preparation-2026-09-08.md) explains the change. The full MacBook Pro M5 comparison below remains the 0.5.0 record.
