...
uses [separate qualification records](../../../../docs/records/0.5.1/hybrid/). Do not pool the candidates.
...
```sh
python3 scripts/records/analyze-release-051.py benchmarks/records/0.5.1/quarter --output /tmp/lighter-051-analysis
```

See [the generated report](../../../RELEASE-0.5.1-QUARTER.md) for measurements and limitations.
