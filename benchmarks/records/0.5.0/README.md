...
The [release report](../../RELEASE-0.5.0.md) explains the
statistics; [competitor methods](../../RELEASE-0.5.0-COMPETITORS.md)
...
```sh
python3 scripts/records/analyze-release-050.py benchmarks/records/0.5.0 --output /tmp/lighter-050-analysis
# Plot dependencies used for these figures: matplotlib 3.11.1.
python3 scripts/records/plot-release-050.py benchmarks/records/0.5.0 --output /tmp/lighter-050-plots
