...
The full records are the archived [M5 share](results/archive/38bfab4/m5/lighter.csv), [guest disk](results/archive/38bfab4/m5/lighter-guest.csv), [amd64](results/archive/38bfab4/m5/lighter-amd64.csv), and [M1 share](results/archive/38bfab4/m1/lighter.csv), [guest disk](results/archive/38bfab4/m1/lighter-guest.csv), [amd64](results/archive/38bfab4/m1/lighter-amd64.csv) CSVs. Their adjacent `.tree` files retain the measured runtime commit and guest-artifact hashes. Documentation and packaging metadata committed afterward do not change the runtime measured here.
