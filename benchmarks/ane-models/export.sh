...
build yolov9.Dockerfile yolov9-t-320.onnx --build-arg MODEL_SIZE=t --build-arg IMG_SIZE=320
build yolov9.Dockerfile yolov9-s-640.onnx --build-arg MODEL_SIZE=s --build-arg IMG_SIZE=640
...
build deimv2.Dockerfile deimv2_hgnetv2_n.onnx --build-arg BACKBONE=hgnetv2 --build-arg MODEL_SIZE=n
